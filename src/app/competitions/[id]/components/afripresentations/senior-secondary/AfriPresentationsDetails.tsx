...
export function AfriPresentationsDetails({ comp, undertakingChecked, onUndertakingChange, onApply }: Props) {
  ...
  return (
    <div className="space-y-6">
      <DescriptionSection description={SS_DATA.DESCRIPTION} />
      <RegistrationRequirementsSection
        requirements={SS_DATA.REGISTRATION_REQUIREMENTS}
        country={comp.country}
        fee={comp.registrationFee}
      />
      <RulesSection rules={SS_DATA.RULES} />
      <ParentGuardianSection />
      <ScreeningSection criteria={SS_DATA.SELECTION_CRITERIA} />
      <ConsentSection consent={SS_DATA.CONSENT} />
      <RewardSection rewards={SS_DATA.REWARDS} />
      <UndertakingSection
        undertaking={SS_DATA.UNDERTAKING}
