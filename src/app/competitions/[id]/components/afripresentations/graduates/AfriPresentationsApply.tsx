...
import { DepartmentSection, DegreeTypeSection } from '../shared/components/ExtraFormSections';
import {
...
export function AfriPresentationsApply({ comp }: Props) {
  ...
  const validate = () => {
    ...
    if (!degreeCert) { toast.error('Please upload your degree certificate.'); return false; }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm border border-neutral-gray-light space-y-6">
        ...
        <DegreeTypeSection degreeType={degreeType} otherDegreeType={otherDegreeType} onDegreeTypeChange={setDegreeType} onOtherDegreeTypeChange={setOtherDegreeType} />
        <IdCardUploadSection
          label="Degree Certificate"
          description='Upload "Degree Certificate"'
          preview={degreeCert?.preview || null}
          fileName={degreeCert?.file.name || null}
          onUpload={handleDegreeCertUpload}
        />
