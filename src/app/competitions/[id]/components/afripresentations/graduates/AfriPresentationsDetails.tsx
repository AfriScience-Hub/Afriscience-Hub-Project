...
export function AfriPresentationsDetails({ comp, undertakingChecked, onUndertakingChange, onApply }: Props) {
  ...
  return (
    <div className="space-y-6">
      <DescriptionSection description={GR_DATA.DESCRIPTION} />
      <RegistrationRequirementsSection
        requirements={GR_DATA.REGISTRATION_REQUIREMENTS}
        country={comp.country}
        fee={comp.registrationFee}
      />
      <RulesSection rules={GR_DATA.RULES} />
      <ScreeningSection criteria={GR_DATA.SELECTION_CRITERIA} />
      <ConsentSection consent={GR_DATA.CONSENT} />
      <RewardSection rewards={GR_DATA.REWARDS} />
      <UndertakingSection
        undertaking={GR_DATA.UNDERTAKING}
