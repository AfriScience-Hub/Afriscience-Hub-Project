...
export function AfriPresentationsDetails({ comp, undertakingChecked, onUndertakingChange, onApply }: Props) {
  ...
  return (
    <div className="space-y-6">
      <DescriptionSection description={UP_DATA.DESCRIPTION} />
      <RegistrationRequirementsSection
        requirements={UP_DATA.REGISTRATION_REQUIREMENTS}
        country={comp.country}
        fee={comp.registrationFee}
      />
      <RulesSection rules={UP_DATA.RULES} />
      <ParentGuardianSection />
      <ScreeningSection criteria={UP_DATA.SELECTION_CRITERIA} />
      <ConsentSection consent={UP_DATA.CONSENT} />
      <RewardSection rewards={UP_DATA.REWARDS} />
      <UndertakingSection
        undertaking={UP_DATA.UNDERTAKING}
