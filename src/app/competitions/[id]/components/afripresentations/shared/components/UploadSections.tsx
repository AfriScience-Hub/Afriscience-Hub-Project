...
const GOVT_ID_CARD_TYPES = ['National ID Card', "Driver's Licence", 'International Passport', 'Other'];

export function GovernmentIdSection({ idType, otherIdType, preview, fileName, onIdTypeChange, onOtherIdTypeChange, onUpload }: GovernmentIdSectionProps) {
  const ref = useRef<HTMLInputElement>(null);
