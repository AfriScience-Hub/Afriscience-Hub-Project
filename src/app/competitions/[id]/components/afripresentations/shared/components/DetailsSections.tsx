  ...
  return (
    <section className="bg-white rounded-xl p-6 shadow-sm border border-neutral-gray-light">
      ...
      <ul className="space-y-2.5 text-sm text-neutral-gray-dark leading-relaxed">
        ...
        <ul className="ml-6 space-y-2 border-l border-neutral-gray-light/60 pl-4">
          {criteria.map((c, idx) => (
            <li key={idx} className="flex items-start gap-2.5">
              <span className="mt-2 h-1.5 w-1.5 rounded-full bg-neutral-gray-dark flex-shrink-0" />
              <span>{c}</span>
            </li>
          ))}
        </ul>
        <li className="flex items-start gap-3">
          <span className="mt-2 h-2 w-2 rounded-full bg-neutral-black flex-shrink-0" />
          <span>Top 30 finalists will be listed under the &apos;Voting&apos; section of the platform after four (4) weeks of submission deadline.</span>
        </li>
        <li className="flex items-start gap-3">
          <span className="mt-2 h-2 w-2 rounded-full bg-neutral-black flex-shrink-0" />
          <span>Public votes will be used to determine the final performance of finalists.</span>
        </li>
        <li className="flex items-start gap-3">
          <span className="mt-2 h-2 w-2 rounded-full bg-neutral-black flex-shrink-0" />
          <span>At the end of voting sessions, winners will be ranked, announced and rewarded under the &apos;Awards&apos; section of the platform.</span>
        </li>
        <li className="flex items-start gap-3">
          <span className="mt-2 h-2 w-2 rounded-full bg-neutral-black flex-shrink-0" />
          <span>When a tie exists either in the 1st, 2nd or 3rd positions, it will be resolved by further extending the voting window for affected finalists by 48 hours.</span>
        </li>
      </ul>
    </section>
  );
