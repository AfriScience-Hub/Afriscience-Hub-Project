...
export function AfriPresentationsSubmission({ comp }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      <UploadMediaSection submitted={submitted} uploadedFile={uploadedFile} previewUrl={previewUrl} submitting={submitting} onFileChange={handleFileChange} onSubmit={handleSubmit} onResubmit={() => {}} />
