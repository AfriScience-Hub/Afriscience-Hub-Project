      ...
      <section className="bg-white rounded-xl p-6 shadow-sm border border-neutral-gray-light">
        ...
        <ul className="space-y-2.5 text-sm text-neutral-gray-dark leading-relaxed">
          ...
          <ul className="ml-6 space-y-2 border-l border-neutral-gray-light/60 pl-4">
            <li className="flex items-start gap-2.5"><span className="mt-2 h-1.5 w-1.5 rounded-full bg-neutral-gray-dark flex-shrink-0" /><span>Scientific relatedness</span></li>
            <li className="flex items-start gap-2.5"><span className="mt-2 h-1.5 w-1.5 rounded-full bg-neutral-gray-dark flex-shrink-0" /><span>Space arrangement</span></li>
            <li className="flex items-start gap-2.5"><span className="mt-2 h-1.5 w-1.5 rounded-full bg-neutral-gray-dark flex-shrink-0" /><span>Space functionality</span></li>
          </ul>
