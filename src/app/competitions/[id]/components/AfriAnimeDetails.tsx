      ...
      <section className="bg-white rounded-xl p-6 shadow-sm border border-neutral-gray-light">
        ...
        <ul className="space-y-2.5 text-sm text-neutral-gray-dark leading-relaxed">
          <li className="flex items-start gap-3">
            <span className="mt-2 h-2 w-2 rounded-full bg-neutral-black flex-shrink-0" />
            <span>All submitted entries will be reviewed and scored by our competition panel in the following areas:</span>
          </li>
          <ul className="ml-6 space-y-2 border-l border-neutral-gray-light/60 pl-4">
            <li className="flex items-start gap-2.5"><span className="mt-2 h-1.5 w-1.5 rounded-full bg-neutral-gray-dark flex-shrink-0" /><span>Scientific accuracy</span></li>
            <li className="flex items-start gap-2.5"><span className="mt-2 h-1.5 w-1.5 rounded-full bg-neutral-gray-dark flex-shrink-0" /><span>Concept clarity</span></li>
            <li className="flex items-start gap-2.5"><span className="mt-2 h-1.5 w-1.5 rounded-full bg-neutral-gray-dark flex-shrink-0" /><span>Creativity</span></li>
            <li className="flex items-start gap-2.5"><span className="mt-2 h-1.5 w-1.5 rounded-full bg-neutral-gray-dark flex-shrink-0" /><span>Technical quality</span></li>
            <li className="flex items-start gap-2.5"><span className="mt-2 h-1.5 w-1.5 rounded-full bg-neutral-gray-dark flex-shrink-0" /><span>Audience Engagement</span></li>
          </ul>
