    ...
    <div className="space-y-6">
        ...
        <div className="rounded-lg border border-neutral-gray-light bg-neutral-bg-light p-4 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <input type="text" value={props.industry} onChange={e => props.onIndustryChange(e.target.value)} placeholder="e.g., Energy & Power" className="w-full px-3 py-2 rounded-lg border border-neutral-gray-light bg-white focus:outline-none focus:border-brand-navy-900" required />
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" value={props.workCountry} onChange={e => props.onWorkCountryChange(e.target.value)} placeholder="e.g., Nigeria" className="w-full px-3 py-2 rounded-lg border border-neutral-gray-light bg-white focus:outline-none focus:border-brand-navy-900" required />
            </div>
            <div>
      ...
      <div className="pt-4 border-t border-neutral-gray-light">
        <div className="flex items-center justify-between mb-4">
          <h4 className="text-base font-bold text-neutral-black">Past Employment</h4>
          <button type="button" onClick={props.onAddPastJob} className="inline-flex items-center gap-1 px-3 py-1.5 text-sm font-medium text-green-600 border border-green-600 rounded-lg hover:bg-green-50 transition-colors">
        ...
        {props.pastJobs.map((job) => (
          <div key={job.id} className="rounded-lg border border-neutral-gray-light bg-neutral-bg-light p-4 mb-3">
            <div className="flex items-center justify-between mb-3">
              ...
              <button type="button" onClick={() => props.onRemovePastJob(job.id)} className="text-red-500 hover:text-red-700 transition-colors">
      ...
      <div className="pt-4 border-t border-neutral-gray-light">
        <div className="flex items-center justify-between mb-4">
          <h4 className="text-base font-bold text-neutral-black">Skills / Expertise</h4>
          <button type="button" onClick={props.onAddSkill} className="inline-flex items-center gap-1 px-3 py-1.5 text-sm font-medium text-green-600 border border-green-600 rounded-lg hover:bg-green-50 transition-colors">
        ...
        <div className="flex flex-wrap gap-2">
          {props.skills.map((skill) => (
            <div key={skill.id} className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-neutral-gray-light bg-white">
              ...
              <button type="button" onClick={() => props.onRemoveSkill(skill.id)} className="text-red-400 hover:text-red-600 transition-colors">
      ...
      <div className="pt-4 border-t border-neutral-gray-light">
        <div className="flex items-center justify-between mb-4">
          <h4 className="text-base font-bold text-neutral-black">Language Proficiency</h4>
          <button type="button" onClick={props.onAddLanguage} className="inline-flex items-center gap-1 px-3 py-1.5 text-sm font-medium text-green-600 border border-green-600 rounded-lg hover:bg-green-50 transition-colors">
        ...
        {props.languages.map((lang) => (
          <div key={lang.id} className="flex items-center gap-3 mb-2">
            ...
            <button type="button" onClick={() => props.onRemoveLanguage(lang.id)} className="text-red-500 hover:text-red-700 transition-colors">
              <Trash2 className="h-4 w-4" />
            </button>
          </div>
        ))}
      ...
      <div className="pt-4 border-t border-neutral-gray-light">
        <div className="flex items-center justify-between mb-4">
          ...
          <button type="button" onClick={props.onAddPortfolioLink} className="inline-flex items-center gap-1 px-3 py-1.5 text-sm font-medium text-green-600 border border-green-600 rounded-lg hover:bg-green-50 transition-colors">
        ...
        {props.portfolioLinks.map((link) => (
          <div key={link.id} className="flex items-center gap-3 mb-2">
            ...
            <button type="button" onClick={() => props.onRemovePortfolioLink(link.id)} className="text-red-500 hover:text-red-700 transition-colors">
              <Trash2 className="h-4 w-4" />
            </button>
          </div>
        ))}
      ...
      <div className="pt-4 border-t border-neutral-gray-light">
        <label className="block text-sm font-medium text-neutral-gray-dark mb-2">Upload CV</label>
