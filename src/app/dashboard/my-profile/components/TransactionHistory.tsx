...
import { formatMinor, formatISOString, shortReference, statusTone } from '../walletUtils';
            ...
            <tbody className="divide-y divide-neutral-gray-light">
              {rows.map((tx) => {
                ...
                if (isWallet) {
                  ...
                  id = shortReference(w.reference) || shortReference(w.id);
                ...
                return (
                  <tr key={tx.id} className="hover:bg-neutral-bg-light transition-colors">
                    <td className="px-4 py-3 font-medium text-neutral-black">{id}</td>
                    <td className="px-4 py-3 text-neutral-gray-medium">{date}</td>
                    <td className="px-4 py-3 text-neutral-gray-medium">{desc}</td>
