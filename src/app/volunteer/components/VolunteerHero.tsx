...
export default function VolunteerHero({ scrollToForm }: VolunteerHeroProps) {
  return (
    <section className="relative bg-brand-navy-900 py-20 overflow-hidden">
      ...
      <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl">
          ...
          <Button size="lg" onClick={scrollToForm} className="h-12 px-8 bg-brand-red-600 hover:bg-brand-red-700 text-base">
