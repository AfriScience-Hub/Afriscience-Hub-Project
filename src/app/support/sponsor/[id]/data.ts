export const MOCK_SPONSOR = {
  ...
  catalog: [
    { industry: 'Technology', items: [
      { name: 'Software Development', price: '$5,000 - $50,000' },
      { name: 'Cloud Solutions', price: '$2,000/month' },
      { name: 'AI Integration', price: '$10,000 - $100,000' },
    ]},
    { industry: 'Telecommunications', items: [
      { name: 'Network Infrastructure', price: '$15,000 - $100,000' },
      { name: 'VoIP Solutions', price: '$1,000/month' },
    ]},
    { industry: 'Artificial Intelligence', items: [
      { name: 'Machine Learning Models', price: '$5,000 - $50,000' },
      { name: 'Computer Vision', price: '$8,000 - $40,000' },
    ]},
  ],
  licenses: [
  ...
  policies: [
    ...
    'Support services available 24/7 for enterprise clients',
  ],
  awards: [
  ...
  contact: {
    ...
    email: 'info@techconnect.africa',
    website: 'www.techconnect.africa',
    linkedin: 'techconnect-africa',
    twitter: '@techconnectafrica',
    facebook: 'TechConnectAfrica',
