...
export const PROGRAM_DETAILS: Record<ImpactProgram, ProgramDetails> = {
  'Career Support': {
    ...
    applicationRequirements: [
      ...
      'Most recent degree certificate of primary proprietor',
      'Employment Letter/Training Certificate of primary proprietor',
